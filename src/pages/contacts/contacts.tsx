...
function Contacts() {
  ...
  (<Box>
    <Box className='contacts-info-label'>
      {icon}
      <p style={{fontSize: '24px'}}> {text} </p>
    </Box>
    <Box className='contacts-info-text'>
      {children}
    </Box>
  </Box>);
  ...
  return (
    <Box 
      className='contacts-root contacts-padding' 
      style={{ backgroundSize: '100% auto',backgroundImage: `url(${ToyotaWallpaper})`, backgroundRepeat: 'no-repeat'}}
    >
      <Box className='contacts-padding contacts-info'>
        <Box className='contacts-padding contacts-fade' >
        ...
        <Box className='contacts-fade contacts-padding' style={{justifyContent: 'center', display: 'flex' }}>
          <IconButton><FaFacebookSquare className='contacts-icon'/></IconButton>
          <IconButton><SiViber className='contacts-icon'/></IconButton>
          <IconButton><img src={MobileBg} className='contacts-icon'></img></IconButton>
        </Box>
      </Box>
      {/* <Box ><Map/></Box> */} {/* Toggle for leaflet map */}
      <Box className='contacts-padding contacts-map'>
